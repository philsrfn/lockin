...
const styles = StyleSheet.create({
  ...
  heroUnit: { fontSize: 17, fontWeight: '700', color: colors.text },
  heroSub: { fontSize: 13, color: colors.textFaint },
  ...
  tileMacros: { fontSize: 14, color: colors.accent, fontWeight: '600' },
